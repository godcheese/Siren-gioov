...
function get_tag_list(){
    ...
    if(!empty($categories) && is_array($categories)) {
        $result .= '<ul class="link-items fontSmooth">';
        foreach ($categories as $tag) {
            $tag_name = $tag->name;
            $tag_link = get_tag_link($tag);
            $tag_count = $tag->count;
            $result .= '<li class="link-item"><a class="link-item-inner effect-apollo" href="' . $tag_link . '" title="' . $tag_name . '" target="_blank" ><span class="sitename">' . $tag_name . '</span><div class="linkdes">' . $tag_count . ' 篇文章</div></a></li>';
